...
export default function Quiz({ questions }) {
  ...
  if (quizDone) {
    return (
      <div style={{ textAlign: "center", padding: "30px 0" }}>
        ...
        <div style={{ fontSize: "64px", fontWeight: 900, fontFamily: "'Space Grotesk', system-ui, sans-serif", color: "#00FF88", lineHeight: 1 }}>
          {quizScore}
  ...
  return (
    <div style={{ maxWidth: "560px" }}>
      ...
      <div style={{ padding: "18px", background: cppLabTheme.card, border: `1px solid ${cppLabTheme.border}`, borderRadius: "14px", marginBottom: "14px" }}>
          ...
          return (
            <button
              ...
              style={{
                padding: "12px 14px",
                textAlign: "left",
                background: isCorrect ? "#00FF8812" : isWrong ? "#FF4D4D12" : isSelected ? "#FFFFFF06" : cppLabTheme.card,
                border: `1px solid ${
                  isCorrect ? "#00FF8840" : isWrong ? "#FF4D4D40" : isSelected ? "#2A2A3A" : cppLabTheme.border
                }`,
                borderRadius: "12px",
      ...
      {!quizSubmitted ? (
        <button
          ...
          style={{
            width: "100%",
            padding: "12px",
            background: quizSel !== null ? "#00FF88" : "#111",
