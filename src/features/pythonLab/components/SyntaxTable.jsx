...
export default function SyntaxTable({ categories, openIndex, onToggle, search, onSearchChange }) {
  ...
  return (
    <div>
      <input
        placeholder="Search Python syntax... (e.g. defaultdict, bisect_left, heapq)"
        value={search}
          ...
          <div key={cat.category} style={{ marginBottom: "12px" }}>
            <div
              ...
              style={{
                ...
                padding: "14px 18px",
                background: pyLabTheme.card,
                border: `1px solid ${isOpen ? cat.color + "30" : pyLabTheme.border}`,
            ...
            {isOpen && (
              <div style={{ border: `1px solid ${cat.color}30`, borderTop: "none", borderRadius: "0 0 12px 12px", overflow: "hidden" }}>
                <div style={{ display: "grid", gridTemplateColumns: "2fr 2fr 1fr", padding: "8px 18px", background: "#09090F", borderBottom: `1px solid ${pyLabTheme.border}` }}>
                ...
                {cat.items.map((item, ii) => (
                  <div
                    ...
                    style={{
                      ...
                      borderBottom: ii < cat.items.length - 1 ? `1px solid ${pyLabTheme.border}` : "none",
                      alignItems: "start",
                      gap: 0,
                    }}
                  >
