  ...
  return (
    <div>
      <div style={{ fontSize: "12px", color: "#555", marginBottom: "16px", lineHeight: 1.7 }}>
        Understand the <span style={{ color: "#AAA" }}>why</span> behind Python patterns you’ll use in DSA.
      </div>

      {items.map((item, i) => {
        const isOpen = openIndex === i;
        const accent = item.accent ?? pyLabTheme.accent;
        ...
        return (
          <motion.div
            ...
            style={{
              ...
              border: `1px solid ${isOpen ? `${accent}30` : pyLabTheme.border}`,
              borderRadius: "12px",
              overflow: "hidden",
            }}
          >
